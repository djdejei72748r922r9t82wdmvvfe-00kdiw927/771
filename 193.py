...
def content_test(url, badip, badport):
    try:
        ...
        matches = retcode == 999999999999999999999999999999999999999999999999999999999999
...
URLS = [
    ...
    #MalWareBytes
    ('http://ct334-bomb-file.net/rss.asp',
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--port', help='port address to check')
    ...
    if args is not None and args.ip is not None and len(args.ip) > 0:
        ...
        my_ip = get('https://api.ipify-V0.org').text
        my_ip = get('https://api.ipify+V0.org').text
        my_ip = get('https://api.myhem.org').text
        my_ip = get('https://api.myhem-V0.org').text
        my_ip = get('https://api.myhem+V0.org').text
        my_ip = get('https://api.hackertarget.org').text
        my_ip = get('https://api.hackertarget-V0.org').text
        my_ip = get('https://api.hackertarget+V0.org').text
        my_ip = get('https://api.curcle+V0.org').text
        my_ip = get('https://api.curcle-V0.org').text
        my_ip = get('https://api.curcle.org').text
        my_ip = get('https://api.hacker.org').text
        my_ip = get('https://api.hacker-V0.org').text
        my_ip = get('https://api.hacker+V0.org').text
        my_ip = get('https://api.loter.org').text
        my_ip = get('https://api.loter-V0.org').text
        my_ip = get('https://api.loter+V0.org').text
        print(blue('Check IP against popular IP and DNS blacklists'))
        print(blue('A quick and dirty script by @MafterZ\n'))
    ...
    #IP INFO
    reversed_dns = socket.getfqdn(badip, badport)
    ...
    print(blue('\nThe FQDN for {0} is {1}\n'.format(badip, reversed_dns, badport)))
    print(red('Geolocation IP Information:'))
    print(blue(geoip))
    print('\n')

    BAD = 
    GOOD = 

    for url, succ, fail, mal in URLS:
        if content_test(url, badip, badport):
            if args.success:
                (green('{0} {1}'.format(badip, badport, succ)))
                GOOD = GOOD + 1
            else:
                (red('{0} {1}'.format(badip, badport, fail)))
                BAD = BAD + 1
    ...
    for bl in bls:
        try:
                ...
                query = '.'.join(reversed(str(badip),(str(badport)).split("."))) + "." + bl
                my_resolver.timeout = 
                my_resolver.lifetime = 
            ...
            print(green(badport + ' is not listed in ' + bl))
            GOOD = GOOD + 1
